...
function SignupPage() {
  ...
  return (
    ...
    //   <div className="bg-white/10 p-8 rounded-xl backdrop-blur-md w-full max-w-md shadow-xl">
    ...
    //             required
    //             className="w-full px-4 py-2 rounded-lg bg-purple-900/50 border border-purple-500 text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
    //             placeholder="John"
    //           />
    //         </div>
    //         <div>
    ...
    //       <button
    //         type="submit"
    //         className="w-full py-3 px-4 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-900 transition-colors duration-200"
    //       >
    //         Sign Up
    //       </button>
    //     </form>
